...
- model_EDA.Rmd: this should be a journal like document that describes your exploratory data analysis and provides 
visualizations and summaries of any useful insights. Also, if you have ideas for creating new variables - also know as
feature engineering - they should be documented here. Save this file *docs/model*   
...
load the saved model from *data/models*, and use the *predict* function to score the new data. This scored data can be
saved in the *data/scoring* folder (not shown). 
